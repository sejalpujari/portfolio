...
const FloatingNavbar = ({ navItems, activeSection, onSectionClick }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-2 bg-black/80 backdrop-blur-md border border-gray-800 rounded-full px-6 py-3 mx-auto min-w-[280px] max-w-[80%] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px]">
        {navItems.map((item) => (
          <button
            key={item.id}
